...
CREATE TABLE `activity_logs` (
  ...
  `activities` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `announcements` (
  ...
  `is_approved` enum('y','n') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'n',
...
INSERT INTO `announcements` (`id`, `uuid`, `subject`, `text`, `is_approved`, `approved_by`, `thumbnail`, `created_at`, `updated_at`) VALUES
(1, NULL, 'Neque porro quisquam est qui dolorem ipsum quia dolor sit amet', '<p align=\"justify\">\r\nLorem ipsum dolor sit amet, consectetur adipiscing elit. Cras id ipsum \r\nligula. Cras in tortor et erat iaculis interdum. Mauris dignissim ornare\r\n semper. Duis volutpat, lacus ac volutpat eleifend, dolor dui tincidunt \r\nmetus, id scelerisque libero felis sit amet ante. Sed mauris urna, \r\nultrices vel lorem et, ornare commodo felis. Aenean vulputate ipsum sit \r\namet tellus finibus, pretium vulputate libero porttitor. Morbi lacinia \r\nullamcorper lorem, a semper quam dictum in. Suspendisse nec ullamcorper \r\nest. Curabitur malesuada, sem mattis pulvinar efficitur, augue nisl \r\nconsequat nisi, non laoreet turpis magna maximus orci. Sed auctor dolor \r\nelit, ut ultrices nisl mollis mattis. Maecenas quis lobortis nunc. Morbi\r\n fermentum, quam in scelerisque aliquet, justo metus lacinia enim, ac \r\ntempor lectus dolor nec velit. Duis suscipit ac mauris nec pharetra. \r\nMauris mollis ac sem at mollis. Proin vulputate viverra dapibus. Etiam \r\nfeugiat vel libero in pharetra.\r\n</p>\r\n<p align=\"justify\">\r\nQuisque vitae ex erat. Fusce vulputate pharetra augue. Pellentesque \r\nvitae nisl eget quam pretium mattis ut et arcu. Fusce tincidunt tempus \r\nimperdiet. Integer lacinia nisl eu massa porta, sit amet viverra ex \r\nfaucibus. Morbi leo ligula, ultrices et ex rutrum, placerat vestibulum \r\nnisi. Aenean nibh libero, vulputate eget fringilla venenatis, iaculis \r\nsed mauris.\r\n</p>\r\n<p align=\"justify\">\r\nSed sed neque dui. Vestibulum eleifend est orci, nec sagittis risus \r\nmollis eget. Quisque non rutrum ligula. Vivamus mi velit, suscipit a \r\nvulputate eget, eleifend vel odio. Aenean varius ut augue ac viverra. \r\nPellentesque lectus quam, porta sit amet ultrices ut, aliquet ac nisi. \r\nNunc semper massa nec nisl tristique dignissim. Sed id aliquam enim. \r\nMorbi quis massa dignissim, hendrerit magna et, accumsan lorem.\r\n</p>\r\n<p align=\"justify\">\r\nSed ante massa, porta auctor velit ut, pulvinar consectetur justo. \r\nPraesent consectetur, quam vel efficitur fringilla, nulla nisl cursus \r\nlectus, non porta dolor arcu scelerisque enim. Cras consequat dolor eget\r\n augue imperdiet condimentum. Nunc aliquam dui at velit vestibulum, non \r\npulvinar sem rhoncus. Sed laoreet quis est a dignissim. Suspendisse eu \r\nlacinia nisi, id rhoncus massa. Pellentesque et convallis leo, vitae \r\niaculis mauris. Quisque porttitor vehicula eros vel gravida. Duis mollis\r\n sagittis nisl.\r\n</p>', 'y', 4, 'firmbee-com-gcsNOsPEXfs-unsplash.jpg', '2021-07-31 23:55:02', '2021-07-31 23:55:02');
...
CREATE TABLE `announcement_files` (
  ...
  `file_ext` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `file_meta_data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `assesments` (
  ...
  `status` enum('pending','approved','reject') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `assesments` (`id`, `uuid`, `student_id`, `course_id`, `unit_id`, `links`, `schedule`, `status`, `created_at`, `updated_at`) VALUES
(1, NULL, 6, NULL, 1, 'https://www.youtube.com/watch?v=KkSD3vF4M7c&list=RDGMEMJQXQAmqrnmK1SEjY_rKBGA&index=4', NULL, 'pending', '2022-03-02 08:31:27', '2022-03-02 08:31:27'),
(2, NULL, 6, NULL, 1, 'https://www.youtube.com/watch?v=KkSD3vF4M7c&list=RDGMEMJQXQAmqrnmK1SEjY_rKBGA&index=4', NULL, 'pending', '2022-03-03 23:22:25', '2022-03-03 23:22:25');
...
CREATE TABLE `courses` (
  `id` bigint UNSIGNED NOT NULL,
  `uuid` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `course_code` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `is_published` enum('y','n') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'n',
  `course_thumbnail` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `course_categories` (
  `id` bigint UNSIGNED NOT NULL,
  `uuid` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `category_code` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `course_units` (
  ...
  `uuid` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `course_id` bigint UNSIGNED DEFAULT NULL,
  `unit_type` enum('core','elective') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `unit_code` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `enrollments` (
  ...
  `student_id` bigint UNSIGNED DEFAULT NULL,
  `course_id` bigint UNSIGNED DEFAULT NULL,
  `core_units` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `elective_units` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `current_unit` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_passed` enum('y','n') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'n',
...
(3, 'NkpYem9hQTlpY2JXRllSRjVoOEYxZz09', 7, 1, '[\"SHBBFAS001\",\"SHBBBOS001\"]', NULL, NULL, 'n', NULL, NULL, '2021-08-01 01:38:15', '2021-08-04 21:05:32', NULL);
...
CREATE TABLE `posts` (
  ...
  `type` enum('post','assignment','material') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `steps` (
  `id` bigint UNSIGNED NOT NULL,
  `uuid` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `step_name` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `descriptions` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `thumbnail` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `temp_user_photos` (
  ...
  `foldername` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `unit_progress` (
  ...
  `complete_step` int NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(2, NULL, 6, 1, 1, 5, 4, '2021-08-01 01:35:09', '2022-02-28 19:54:34'),
(3, NULL, 7, 1, 1, 1, 0, '2021-08-01 01:38:23', '2021-08-01 01:38:23'),
(4, NULL, 7, 1, 3, 1, 0, '2021-08-04 21:05:32', '2021-08-04 21:05:32');
...
CREATE TABLE `users` (
  ...
  `user_type` enum('staff','teacher','student') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `isBanned` enum('yes','no') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'no',
...
(2, 'SWVWdTFhTjlGRmRXdGZzcnRnNmp1dz09', NULL, NULL, 'Jhon', 'tech@gmail.com', NULL, '$2y$10$dsBVDcjlig088Ai0yLoqLeAcXQQLeLh6BhMlKYSR6wQWQrQB.Es5y', 'f36a20f23ed268dc23c445cae45f3056.jpg', 'teacher', 'no', NULL, '2021-07-30 06:01:07', '2021-08-01 01:24:48', NULL),
...
CREATE TABLE `zoom_meetings` (
  ...
  `meeting_id` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `start_url` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `schedule` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `zoom_meetings` (`id`, `host_id`, `meeting_id`, `start_url`, `schedule`, `password`, `created_at`, `updated_at`) VALUES
(14, 2, '86731957846', 'https://us05web.zoom.us/s/86731957846?zak=eyJ0eXAiOiJKV1QiLCJzdiI6IjAwMDAwMSIsInptX3NrbSI6InptX28ybSIsImFsZyI6IkhTMjU2In0..b-I2_GNpfoM6ralcferOWjU-xdiUvyQPdj8Yw3tqn_w', '2021-08-18 17:30:00', 'x43tG9CN', '2021-08-04 04:05:43', '2021-08-04 04:05:43');
